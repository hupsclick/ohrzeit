...
function App() {
  ...
  const { isActive, volume, error, start, stop, setVolume, setEqualizerValue } = useAudio();
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 mb-8">
          ...
          <ul className="text-blue-800 dark:text-blue-200 space-y-2 text-sm">
            <li>•❗Schließen Sie unbedingt Kopfhörer an Ihren Gerät an um Rückkopplungen zu vermeiden</li>
        ...
        >
          <div className="space-y-4">
		   Entwickelt für Menschen mit Hörproblemen<br />
        ...
        >
          <div className="space-y-4">
            ...
            <p>
              Nur Ihre Einstellungen (Lautstärke, Equalizer, Dark Mode) werden lokal 
            ...
            <p>
              ...
              Behandlung. Bei anhaltenden Hörproblemen konsultieren Sie einen Facharzt.</p>
			  <p>
